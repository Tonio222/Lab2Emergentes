...
class BlankFragment3 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        var txtView2=view.findViewById<TextView>(R.id.textView3)
        txtView2.setText(contadorlistener!!.getValorActual().toString())
        val botonred=view.findViewById<Button>(R.id.button6)
        botonred.setOnClickListener{
            contadorlistener!!.resetar()
            txtView2.setText(contadorlistener!!.getValorActual().toString())
        }
    }
